...
/**
 * Provides the local service interface for BoxToken. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Bijan Vakili
 * @see BoxTokenLocalServiceUtil
...
public interface BoxTokenLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BoxTokenLocalServiceUtil} to access the box token local service. Add custom service methods to {@link com.bvakili.portlet.integration.box.service.impl.BoxTokenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
