...
import com.bvakili.portlet.integration.box.service.BoxTokenLocalService;
...
/**
 * Provides the base implementation for the box token local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bvakili.portlet.integration.box.service.impl.BoxTokenLocalServiceImpl}.
 * </p>
 *
 * @author Bijan Vakili
 ...
 * @generated
 */
public abstract class BoxTokenLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BoxTokenLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.bvakili.portlet.integration.box.service.BoxTokenLocalServiceUtil} to access the box token local service.
	 */
	...
	@Override
	public BoxToken addBoxToken(BoxToken boxToken) throws SystemException {
		boxToken.setNew(true);

		return boxTokenPersistence.update(boxToken);
	}
	 ...
	 */
	@Override
	public BoxToken createBoxToken(long boxTokenId) {
		return boxTokenPersistence.create(boxTokenId);
	}
	...
	@Override
	public BoxToken deleteBoxToken(long boxTokenId)
		throws PortalException, SystemException {
		return boxTokenPersistence.remove(boxTokenId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BoxToken deleteBoxToken(BoxToken boxToken) throws SystemException {
		return boxTokenPersistence.remove(boxToken);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BoxToken.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return boxTokenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return boxTokenPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return boxTokenPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return boxTokenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BoxToken fetchBoxToken(long boxTokenId) throws SystemException {
		return boxTokenPersistence.fetchByPrimaryKey(boxTokenId);
	}
	 ...
	 */
	@Override
	public BoxToken getBoxToken(long boxTokenId)
		throws PortalException, SystemException {
		return boxTokenPersistence.findByPrimaryKey(boxTokenId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return boxTokenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BoxToken> getBoxTokens(int start, int end)
		throws SystemException {
		return boxTokenPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBoxTokensCount() throws SystemException {
		return boxTokenPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BoxToken updateBoxToken(BoxToken boxToken) throws SystemException {
		return boxTokenPersistence.update(boxToken);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.bvakili.portlet.integration.box.model.BoxToken",
			boxTokenLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = boxTokenPersistence.getDataSource();
	...
	private BoxTokenLocalServiceClpInvoker _clpInvoker = new BoxTokenLocalServiceClpInvoker();
}